...
void main() {
  ...
  group('get Popular Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('dummy/popular_movie.json')))
        .movieList;
    ...
    test('should return list of movies when response is success (200)',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy/popular_movie.json'), 200));
      // act
  ...
  group('get Top Rated Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('dummy/top_rated_movie.json')))
        .movieList;
    ...
    test('should return list of movies when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy/top_rated_movie.json'), 200));
      // act
  ...
  group('get movie detail', () {
    ...
    final tMovieDetail = MovieDetailResponse.fromJson(
        json.decode(readJson('dummy/detail_movie.json')));

    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/$tId?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy/detail_movie.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('dummy/recommendations_movie.json')))
        .movieList;
    const tId = 1;
